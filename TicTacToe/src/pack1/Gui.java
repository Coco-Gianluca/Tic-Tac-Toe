...
public class Gui {
	...
	static JButton btn [] = new JButton[9]; //Wir brauchen 9 Button. 1 für jedes Feld
	...
	public Gui() {
		...
		jf.setResizable(false);// das es sich nicht grösser ode kleiner ziehen lässt
		...
		for(int i = 0; i<btn.length; i++){ //damit werden alle Buttonzahlen abgefragt 
			...
			jf.add(btn[i]);//button wird dem JFrame hinzugefügt
		}
